                ...
                <Row gutter={[24, 0]}>
                    <Col span={24}>
                        <Card bordered={false}
                            ...
                            <Row gutter={[0, 0]}>
                                <Col span={4} offset={0}>
                                    <Statistic title="Suit bonus" value={store.User.franchise.suitBonus}/>
                                </Col>
                                <Col span={4} offset={0}>
                                    <Statistic title="Starting EPV" precision={2} value={store.User.franchise.epv}/>
                                </Col>
                                <Col span={4} offset={0}>
                                    <Statistic title="Mean Age" precision={2} value={store.User.franchise.meanAge}/>
                                </Col>
                                <Col span={4} offset={0}>
                                    <Statistic title="Salaries" prefix={'$'} precision={2} value={store.User.franchise.salaries}/>
                                </Col>
                            </Row>
                        </Card>
                    </Col>
