...
export const SignedPlayerIcon: React.FunctionComponent = observer(() => {
    ...
    return (
        <svg xmlSpace="preserve"
            ...
            <g>
                <path d="M44.595 51.362L19.597 26.364l9.847-9.847 24.998 24.998z" stroke-linejoin="round"
                      stroke-linecap="round" stroke-width="2.14297857" stroke="#000" fill="#eba523"></path>
                <path stroke-linecap="round" stroke-width="2.143" stroke="#000" fill="#e0e0e0"
                      d="M29.444 16.516l-4.992-4.992a2.93 2.93 0 0 0-4.144 0l-5.704 5.704a2.93 2.93 0 0 0 0 4.144l4.992 4.992 9.848-9.848z"></path>
                <path d="M51.267 52.738l4.551-4.551-1.376-6.673-4.924 4.924-4.923 4.924z" stroke-linejoin="round"
                      stroke-linecap="round" stroke-width="2.143" stroke="#000" fill="#f5e6c8"></path>
                <path d="M57 53.92l-1.182-5.733-4.551 4.551z" stroke-linejoin="round" stroke-linecap="round"
                      stroke-width="2.143" stroke="#000" fill="#333"></path>
                <path d="M45.826 42.745L28.403 25.323" stroke-linejoin="round" stroke-linecap="round"
                      stroke-width="2.143" stroke="#000" fill="none"></path>
            </g>
        </svg>
    );
})
