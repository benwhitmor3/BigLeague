...
class Players:
    ...
    def __init__(self, name, suit, age, pv, epv, s_epv, contract, p_option, t_option, renew, salary, grade, trainer,
                 team, lineup):
        self.name = name
        self.suit = suit
        self.age = age
    ...
    class Players:
        ...
        # generates lineup with weight choices
        def gen_lineup(self):
            lineup_weight = ["starter"] * 5 + ["bench"] * 3 + ["reserve"] * 2
            self.lineup = random.choice(lineup_weight)
        ...
        def __str__(self):
            return (self.name, self.suit, self.age, self.pv, self.epv, self.s_epv, self.contract, self.t_option,
                    self.p_option, self.renew, self.salary, self.grade, self.team, self.trainer, self.lineup)
        ...
        def to_dict(self):
            return {"name": self.name, "suit": self.suit, "age": self.age, "pv": self.pv, "epv": self.epv,
                    ...
                    "franchise": self.team, "trainer": self.trainer, "lineup": self.lineup}
    ...
    def generation():
        ...
        for i in range(10):
            player = Players("name", "suit", "age", "pv", "epv", "s_epv",
                             "contract", "t_option", "p_option", "renew", "salary", "grade", "trainer", "team", "lineup")
