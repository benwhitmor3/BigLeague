...
var CARET_RIGHT = '\u25B8';
var CollapsibleRow = function (props) {
    var index = props.index, _a = props.style, style = _a === void 0 ? {} : _a, _b = props.className, className = _b === void 0 ? '' : _b, _c = props.header, header = _c === void 0 ? null : _c, _d = props.content, content = _d === void 0 ? null : _d, _e = props.onClick, onClick = _e === void 0 ? function () { } : _e, _f = props.expanded, expanded = _f === void 0 ? false : _f, _g = props.showCaret, showCaret = _g === void 0 ? true : _g, _h = props.caretElement, caretElement = _h === void 0 ? null : _h;
    var providedClassName = className ? className : '';
    var expandedClassName = expanded ? 'expanded' : '';
    var _className = "collapsible-row " + providedClassName + " " + expandedClassName;
    return (React.createElement("div", { key: index, className: _className, style: style },
        React.createElement("div", { className: "collapsible-row-header", onClick: function () { return onClick(index); } },
            showCaret && (React.createElement("span", { className: "row-caret " + (expanded ? 'expanded' : '') }, caretElement ? caretElement : CARET_RIGHT)),
            header),
        expanded && React.createElement("div", { className: "collapsible-row-content" }, content)));
};
...
var Grid = function (_React$PureComponent) {
  ...
  _createClass(Grid, [{
    ...
    value: function componentDidMount() {
      ...
      if (!instanceProps.scrollbarSizeMeasured) {
        this.setState(function (prevState) {
          var stateUpdate = _extends$1({}, prevState, { needToResetStyleCache: false });
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      return _extends$1({}, newState, maybeStateA, maybeStateB);
    }
  }, {
...
var Collection$1 = function (_React$PureComponent) {
  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      return React.createElement(CollectionView, _extends$1({
...
var MultiGrid = function (_React$PureComponent) {
  ...
  _createClass(MultiGrid, [{
    ...
    value: function _renderBottomLeftGrid(props) {
      ...
      var bottomLeftGrid = React.createElement(Grid, _extends$1({}, props, {
      ...
      if (hideBottomLeftGridScrollbar) {
        return React.createElement(
          'div',
          {
            ...
            style: _extends$1({}, this._bottomLeftGridStyle, {
              height: height,
              width: width,
              overflowY: 'hidden'
            }) },
    ...
    value: function _renderBottomRightGrid(props) {
      ...
      return React.createElement(Grid, _extends$1({}, props, {
    ...
    value: function _renderTopRightGrid(props) {
      ...
      if (hideTopRightGridScrollbar) {
        ...
        style = _extends$1({}, this._topRightGridStyle, {
          left: 0
        });
      }

      var topRightGrid = React.createElement(Grid, _extends$1({}, props, {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Grid, _extends$1({}, this.props, {
          autoContainerWidth: true,
    ...
    value: function _createRow(_ref6) {
      ...
      var flattenedStyle = _extends$1({}, style, {
...
function withInfiniteLoader(WrappedComponent) {
    var InfinitelyLoadingComponent = /** @class */ (function (_super) {
        __extends(InfinitelyLoadingComponent, _super);
        function InfinitelyLoadingComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.state = {
                loadedRowsMap: {}
            };
            _this._isRowLoaded = function (_a) {
                var index = _a.index;
                return !!_this.props.data[index];
            };
            return _this;
        }
        // _fetchData = (params: IndexRange) => {
        // 	const { loadedRowsMap } = this.state;
        // 	const { startIndex, stopIndex } = params;
        // 	const { fetchData = () => Promise.reject(null) } = this.props;
        // 	for (let i = startIndex; i <= stopIndex; i++) {
        // 		loadedRowsMap[i] = STATUS_LOADING;
        // 	}
        // 	this.setState({ loadedRowsMap });
        // 	return fetchData(params).then(response => {
        ...
        // 	});
        // };
        InfinitelyLoadingComponent.prototype.render = function () {
            var _this = this;
            var _a = this.props, 
            // dataRowCount = undefined,
            // isArrowIconNeeded = true,
            _b = _a.minimumBatchSize, 
            // dataRowCount = undefined,
            // isArrowIconNeeded = true,
            minimumBatchSize = _b === void 0 ? 10 : _b, _c = _a.threshold, threshold = _c === void 0 ? 10 : _c, fetchData = _a.fetchData, _d = _a.totalRowCount, totalRowCount = _d === void 0 ? 10000 : _d;
            return (React.createElement(InfiniteLoader, { isRowLoaded: this._isRowLoaded, loadMoreRows: fetchData, rowCount: totalRowCount || 10000, minimumBatchSize: minimumBatchSize, threshold: threshold }, function (_a) {
                var onRowsRendered = _a.onRowsRendered, registerChild = _a.registerChild;
                return (React.createElement(WrappedComponent, __assign({}, _this.props, { isRowLoaded: _this._isRowLoaded, 
                    // isArrowIconNeeded={isArrowIconNeeded}
                    // maxRowCount={dataRowCount || 0}
                    registerChild: registerChild, onRowsRendered: onRowsRendered })));
            }));
        };
        return InfinitelyLoadingComponent;
    }(React.Component));
    return InfinitelyLoadingComponent;
}
...
var CollapsibleList = /** @class */ (function (_super) {
    ...
    function CollapsibleList() {
        ...
        _this._onRowClick = function (index) {
            _this.setState({
                expandedRowsMap: _this._getUpdatedExpandedRowsMap(index)
            }, function () { return _this._recomputeRowHeights(index); });
        };
        _this._rowHeight = function (params) {
            return _this.props.rowHeight({
                index: params.index,
                expanded: _this.state.expandedRowsMap[params.index]
            });
        };
        _this._getUpdatedExpandedRowsMap = function (index) {
            var _a;
            return __assign({}, _this.state.expandedRowsMap, (_a = {}, _a[index] = _this.state.expandedRowsMap[index] ? false : true, _a));
        };
        _this._recomputeRowHeights = function (index) {
            if (_this.ListRef) {
                _this.ListRef.recomputeRowHeights(index);
                _this.ListRef.forceUpdateGrid();
            }
        };
        _this._registerThyself = function (ref) {
            _this.ListRef = ref;
            if (_this.props.registerChild)
                _this.props.registerChild(ref);
        };
        _this._rowRenderer = function (params) {
            var _params = {
                index: params.index,
                rowData: _this.props.data[params.index],
                isLoaded: _this.props.isRowLoaded ? _this.props.isRowLoaded({ index: params.index }) : true
            };
            return (React.createElement(CollapsibleRow, { index: params.index, style: params.style, className: _this.props.rowClassName, header: _this.props.rowRenderer(_params), content: _this.props.extraContentRenderer(_params), expanded: _this.state.expandedRowsMap[params.index], onClick: _this._onRowClick }));
        };
        return _this;
    }
    CollapsibleList.prototype.componentDidMount = function () {
        ...
        if (scroller) {
            scroller.addEventListener('wheel', this._onScroll);
        }
    };
    CollapsibleList.prototype.componentWillUnmount = function () {
        var scroller = this.getScroller();
        if (scroller) {
            scroller.removeEventListener('wheel', this._onScroll);
        }
    };
    CollapsibleList.prototype.getScroller = function () {
        var stopScrollPropagation = this.props.stopScrollPropagation;
        return this.ListRef && stopScrollPropagation ? ReactDOM.findDOMNode(this.ListRef) : null;
    };
    CollapsibleList.prototype._onScroll = function (event) {
        var currentTarget = event.currentTarget, deltaY = event.deltaY;
        var scrollTop = currentTarget.scrollTop, scrollHeight = currentTarget.scrollHeight;
        var targetHeight = getComputedStyle(currentTarget).height || '';
        if ((deltaY < 0 && scrollTop <= 0) ||
            (deltaY > 0 && scrollTop >= scrollHeight - parseInt(targetHeight))) {
            event.preventDefault();
        }
    };
    CollapsibleList.prototype.render = function () {
        var _this = this;
        var _a = this.props, _b = _a.data, data = _b === void 0 ? [] : _b, _c = _a.maxRowCount, maxRowCount = _c === void 0 ? 0 : _c, _d = _a.height, height = _d === void 0 ? 500 : _d, _e = _a.onRowsRendered, onRowsRendered = _e === void 0 ? function (_a) { } : _e, _f = _a.noRowsRenderer, noRowsRenderer = _f === void 0 ? undefined : _f, _g = _a.autoSizerProps, autoSizerProps = _g === void 0 ? {} : _g, _h = _a.listProps, listProps = _h === void 0 ? {} : _h;
        return (React.createElement("div", { style: { height: height } },
            React.createElement(AutoSizer, __assign({}, autoSizerProps), function (_a) {
                var width = _a.width, height = _a.height;
                return (React.createElement(List, __assign({}, listProps, { ref: _this._registerThyself, width: width, height: height, rowHeight: _this._rowHeight, overscanRowCount: 20, rowRenderer: _this._rowRenderer, onRowsRendered: onRowsRendered, noRowsRenderer: noRowsRenderer, rowCount: Math.max(data.length, maxRowCount) })));
            })));
    };
    return CollapsibleList;
}(React.Component));
var InfiniteCollapsibleList = withInfiniteLoader(CollapsibleList);
...
var css = "/* Collection default theme */\n\n.ReactVirtualized__Collection {\n}\n\n.ReactVirtualized__Collection__innerScrollContainer {\n}\n\n/* Grid default theme */\n\n.ReactVirtualized__Grid {\n}\n\n.ReactVirtualized__Grid__innerScrollContainer {\n}\n\n/* Table default theme */\n\n.ReactVirtualized__Table {\n}\n\n.ReactVirtualized__Table__Grid {\n}\n\n.ReactVirtualized__Table__headerRow {\n  font-weight: 700;\n  text-transform: uppercase;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.ReactVirtualized__Table__row {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n\n.ReactVirtualized__Table__headerTruncatedText {\n  display: inline-block;\n  max-width: 100%;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n\n.ReactVirtualized__Table__headerColumn,\n.ReactVirtualized__Table__rowColumn {\n  margin-right: 10px;\n  min-width: 0px;\n}\n.ReactVirtualized__Table__rowColumn {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n\n.ReactVirtualized__Table__headerColumn:first-of-type,\n.ReactVirtualized__Table__rowColumn:first-of-type {\n  margin-left: 10px;\n}\n.ReactVirtualized__Table__sortableHeaderColumn {\n  cursor: pointer;\n}\n\n.ReactVirtualized__Table__sortableHeaderIconContainer {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.ReactVirtualized__Table__sortableHeaderIcon {\n  -webkit-box-flex: 0;\n      -ms-flex: 0 0 24px;\n          flex: 0 0 24px;\n  height: 1em;\n  width: 1em;\n  fill: currentColor;\n}\n\n/* List default theme */\n\n.ReactVirtualized__List {\n}";
styleInject(css);

var css$1 = ".collapsible-row {\n\tborder-bottom: 1px solid #ddd;\n\ttransition: all 0.4s cubic-bezier(0.075, 0.82, 0.165, 1);\n}\n\n.collapsible-row .collapsible-row-header {\n\tcursor: pointer;\n\theight: 40px;\n\tline-height: 40px;\n\tcolor: #333333;\n\tdisplay: flex;\n}\n\n.collapsible-row .collapsible-row-header .row-caret {\n\ttransition: all 0.3s;\n\tmargin-left: 10px;\n}\n\n.collapsible-row .collapsible-row-header .row-caret.expanded {\n\ttransform: rotate(90deg);\n}\n\n.collapsible-row .collapsible-row-content {\n\tpadding: 0 12px;\n\tcolor: #888888;\n\ttransition: opacity 0.4s cubic-bezier(0.075, 0.82, 0.165, 1);\n}\n";
styleInject(css$1);

var CollapsibleTable = /** @class */ (function (_super) {
    __extends(CollapsibleTable, _super);
    function CollapsibleTable() {
        ...
        _this._recomputeRowHeights = function (index) {
            if (_this.TableRef) {
                _this.TableRef.recomputeRowHeights(index);
                _this.TableRef.forceUpdateGrid();
            }
        };
        _this._registerThyself = function (ref) {
            _this.TableRef = ref;
        ...
        _this._rowRenderer = function (params) {
            var isLoaded = _this.props.isRowLoaded
                ? _this.props.isRowLoaded({ index: params.index })
                : true;
            var _params = __assign({}, params, { isLoaded: isLoaded });
            return (isLoaded && (React.createElement(CollapsibleRow, { showCaret: _this.props.showCaret, caretElement: _this.props.caretElement, index: params.index, style: params.style, className: _this.props.rowClassName, header: _this.props.rowRenderer(_params), content: _this.props.extraContentRenderer(_params), expanded: _this.state.expandedRowsMap[params.index], onClick: _this._onRowClick })));
        };
        return _this;
    }
    CollapsibleTable.prototype.componentDidMount = function () {
        var scroller = this.getScroller();
        if (scroller) {
            scroller.addEventListener('wheel', this._onScroll);
        }
    };
    CollapsibleTable.prototype.componentWillUnmount = function () {
        var scroller = this.getScroller();
        if (scroller) {
            scroller.removeEventListener('wheel', this._onScroll);
        }
    };
    CollapsibleTable.prototype.getScroller = function () {
        var stopScrollPropagation = this.props.stopScrollPropagation;
        if (this.TableRef && stopScrollPropagation) {
            var tableNode = ReactDOM.findDOMNode(this.TableRef);
            //	@ts-ignore
            return tableNode.querySelector('.ReactVirtualized__Table__Grid');
        }
        else {
            return null;
        }
    };
    CollapsibleTable.prototype._onScroll = function (event) {
        var currentTarget = event.currentTarget, deltaY = event.deltaY;
        var scrollTop = currentTarget.scrollTop, scrollHeight = currentTarget.scrollHeight;
        var targetHeight = getComputedStyle(currentTarget).height || '';
        if ((deltaY < 0 && scrollTop <= 0) ||
    ...
    CollapsibleTable.prototype.render = function () {
        var _this = this;
        var _a = this.props, _b = _a.data, data = _b === void 0 ? [] : _b, 
        // maxRowCount = 0,
        _c = _a.columns, 
        // maxRowCount = 0,
        columns = _c === void 0 ? [] : _c, _d = _a.height, height = _d === void 0 ? 500 : _d, _e = _a.headerHeight, headerHeight = _e === void 0 ? 50 : _e, _f = _a.onRowsRendered, onRowsRendered = _f === void 0 ? function (_a) { } : _f, _g = _a.noRowsRenderer, noRowsRenderer = _g === void 0 ? undefined : _g, _h = _a.autoSizerProps, autoSizerProps = _h === void 0 ? {} : _h, _j = _a.tableProps, tableProps = _j === void 0 ? {} : _j;
        return (React.createElement("div", { className: "table-header-styling", style: { height: height } },
            React.createElement(AutoSizer, __assign({}, autoSizerProps), function (_a) {
                var width = _a.width, height = _a.height;
                return (React.createElement(Table, __assign({}, tableProps, { ref: _this._registerThyself, width: width, height: height, headerHeight: headerHeight, rowCount: data.length, rowHeight: _this._rowHeight, rowRenderer: _this._rowRenderer, onRowsRendered: onRowsRendered, noRowsRenderer: noRowsRenderer, rowGetter: function (_a) {
                        var index = _a.index;
                        return data[index] || {};
                    } }), columns.map(function (props, idx) { return (React.createElement(Column, __assign({}, props, { key: idx }))); })));
            })));
    };
    return CollapsibleTable;
}(React.Component));
var InfiniteCollapsibleTable = withInfiniteLoader(CollapsibleTable);

exports.CollapsibleRow = CollapsibleRow;
exports.CollapsibleList = CollapsibleList;
exports.InfiniteCollapsibleList = InfiniteCollapsibleList;
exports.CollapsibleTable = CollapsibleTable;
exports.InfiniteCollapsibleTable = InfiniteCollapsibleTable;
