import { createElement, Component, PureComponent, Children } from 'react';
...
var CollapsibleRow = function (props) {
    ...
    return (createElement("div", { key: index, className: _className, style: style },
        createElement("div", { className: "collapsible-row-header", onClick: function () { return onClick(index); } },
            showCaret && (createElement("span", { className: "row-caret " + (expanded ? 'expanded' : '') }, caretElement ? caretElement : CARET_RIGHT)),
            header),
        expanded && createElement("div", { className: "collapsible-row-content" }, content)));
};
...
var Collection$1 = function (_React$PureComponent) {
  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      return createElement(CollectionView, _extends$1({
...
var MultiGrid = function (_React$PureComponent) {
  ...
  _createClass(MultiGrid, [{
    ...
    value: function _renderBottomLeftGrid(props) {
      ...
      var bottomLeftGrid = createElement(Grid, _extends$1({}, props, {
    ...
    value: function _renderBottomRightGrid(props) {
      ...
      return createElement(Grid, _extends$1({}, props, {
    ...
    value: function _renderTopRightGrid(props) {
      ...
      var topRightGrid = createElement(Grid, _extends$1({}, props, {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      return createElement(
        ...
        createElement(Grid, _extends$1({}, this.props, {
          autoContainerWidth: true,
...
function withInfiniteLoader(WrappedComponent) {
    var InfinitelyLoadingComponent = /** @class */ (function (_super) {
        ...
        InfinitelyLoadingComponent.prototype.render = function () {
            ...
            return (createElement(InfiniteLoader, { isRowLoaded: this._isRowLoaded, loadMoreRows: fetchData, rowCount: totalRowCount || 10000, minimumBatchSize: minimumBatchSize, threshold: threshold }, function (_a) {
                var onRowsRendered = _a.onRowsRendered, registerChild = _a.registerChild;
                return (createElement(WrappedComponent, __assign({}, _this.props, { isRowLoaded: _this._isRowLoaded, 
...
var CollapsibleList = /** @class */ (function (_super) {
    ...
    function CollapsibleList() {
        ...
        _this._rowRenderer = function (params) {
            ...
            return (createElement(CollapsibleRow, { index: params.index, style: params.style, className: _this.props.rowClassName, header: _this.props.rowRenderer(_params), content: _this.props.extraContentRenderer(_params), expanded: _this.state.expandedRowsMap[params.index], onClick: _this._onRowClick }));
        };
        return _this;
    }
    ...
    CollapsibleList.prototype.getScroller = function () {
        ...
        return this.ListRef && stopScrollPropagation ? findDOMNode(this.ListRef) : null;
    };
    ...
    CollapsibleList.prototype.render = function () {
        ...
        return (createElement("div", { style: { height: height } },
            createElement(AutoSizer, __assign({}, autoSizerProps), function (_a) {
                var width = _a.width, height = _a.height;
                return (createElement(List, __assign({}, listProps, { ref: _this._registerThyself, width: width, height: height, rowHeight: _this._rowHeight, overscanRowCount: 20, rowRenderer: _this._rowRenderer, onRowsRendered: onRowsRendered, noRowsRenderer: noRowsRenderer, rowCount: Math.max(data.length, maxRowCount) })));
            })));
    };
...
var CollapsibleTable = /** @class */ (function (_super) {
    ...
    function CollapsibleTable() {
        ...
        _this._rowRenderer = function (params) {
            ...
            return (isLoaded && (createElement(CollapsibleRow, { showCaret: _this.props.showCaret, caretElement: _this.props.caretElement, index: params.index, style: params.style, className: _this.props.rowClassName, header: _this.props.rowRenderer(_params), content: _this.props.extraContentRenderer(_params), expanded: _this.state.expandedRowsMap[params.index], onClick: _this._onRowClick })));
        };
        return _this;
    }
    ...
    CollapsibleTable.prototype.getScroller = function () {
        ...
        if (this.TableRef && stopScrollPropagation) {
            var tableNode = findDOMNode(this.TableRef);
            //	@ts-ignore
    ...
    CollapsibleTable.prototype.render = function () {
        ...
        return (createElement("div", { className: "table-header-styling", style: { height: height } },
            createElement(AutoSizer, __assign({}, autoSizerProps), function (_a) {
                var width = _a.width, height = _a.height;
                return (createElement(Table, __assign({}, tableProps, { ref: _this._registerThyself, width: width, height: height, headerHeight: headerHeight, rowCount: data.length, rowHeight: _this._rowHeight, rowRenderer: _this._rowRenderer, onRowsRendered: onRowsRendered, noRowsRenderer: noRowsRenderer, rowGetter: function (_a) {
                        var index = _a.index;
                        return data[index] || {};
                    } }), columns.map(function (props, idx) { return (createElement(Column, __assign({}, props, { key: idx }))); })));
            })));
    };
...
export { CollapsibleRow, CollapsibleList, InfiniteCollapsibleList, CollapsibleTable, InfiniteCollapsibleTable };
